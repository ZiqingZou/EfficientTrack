...
from network_model.predictor_no_pre_tar import Predictor
...
wandb.init(project='excavator_end2end-effi_no_pre_tar', name='sim')
...
def train():
    state_fp = '../origin_noise_data/train_dataset/state_' + cfg.data_type + '_' + cfg.represent + '.pt'  # simulation
    target_fp = '../origin_noise_data/train_dataset/target_' + cfg.data_type + '_' + cfg.represent + '.pt'  # _mini
    real_target_fp = '../origin_noise_data/train_dataset/real_target_' + cfg.data_type + '_' + cfg.represent + '.pt'
    ...
    # predictor.load('./state_dict_notarreal2/18000_predictor_2000_9.pth')  # './state_dict_real_round3/18000_predictor_2000_9.pth')
